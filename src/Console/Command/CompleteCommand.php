...
use Triangle\{Console\Completion\CompletionInput,
    Console\Completion\CompletionSuggestions,
    Console\Completion\Output\BashCompletionOutput,
    Console\Completion\Output\CompletionOutputInterface,
    Console\Exception\CommandNotFoundException,
    Console\Exception\ExceptionInterface,
