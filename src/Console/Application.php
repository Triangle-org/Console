...
use Triangle\Console\{Command\Command,
    ...
    Command\GitWebhookCommand,
    Command\HelpCommand,
    Command\InstallCommand,
    Command\LazyCommand,
    Command\ListCommand,
    Command\MakeBootstrapCommand,
    Command\MakeCommandCommand,
    Command\MakeControllerCommand,
    Command\MakeMiddlewareCommand,
    Command\MakeModelCommand,
    Command\NginxDisableCommand,
    Command\NginxEnableCommand,
    Command\PharPackCommand,
...
class Application implements ResetInterface
{
    ...
    {
        if (InstalledVersions::isInstalled('triangle/console')) {
            $this->version = 'v' . InstalledVersions::getVersion('triangle/console');
        } else {
            $this->version = 'v4.0';
        }
