...
{
    protected static string $defaultName = 'plugin:update';
    protected static string $defaultDescription = 'Обновить плагин';
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $output->writeln("Обновление плагина $name");
        $namespace = Util::nameToNamespace($name);
        $install_function = "\\$namespace\\Install::update";
